...
export function DialogContent({
  ...
  return (
    <DialogPrimitive.Portal>
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-2 md:right-4 top-2 md:top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none flex items-center justify-center min-w-[44px] min-h-[44px]">
          <X className="h-4 w-4" />
